            ...
            <div className='flex flex-wrap gap-y-12 max-w-[1400px] mx-auto px-10'>
                <div className='flex-1 basis-[300px]'>
                    ...
                    <p className='text-zinc-600 mt-6 mx-w-[350px]'>
                        Bred for a high content of beneficial substances.our products are fresh too.
                    </p>
                    <p className='text-zincv-800 mt-6'>
                ...
                <div className='p-1 rounded-lg mt-6 flex-1'>
                    ...
                    <div className='flex bg-white p-1 rounded-lg mt-6'>
                        ...
                        <button className='bg-gradient-to-b from-orange-400 to orange-500 p-2 rounded-lg text-white text-2xl hover:yo-orange-600 cursor-pointer'>
                            <IoIosArrowForward />
                        </button>
                    </div>
                </div>
